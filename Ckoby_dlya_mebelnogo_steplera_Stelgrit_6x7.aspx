<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Ckoby_dlya_mebelnogo_steplera_Stelgrit_6x7.aspx.cs" Inherits="vorsinstrument.Ckoby_dlya_mebelnogo_steplera_Stelgrit_6x7" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html>
<head><link rel="icon" href="http://vorsinstrument.ru/favicon.ico" type="image/x-icon">
<title>Cкобы для мебельного степлера каленые 6x0,7 мм 1000 шт./уп. "Stelgrit"</title>
<meta name="description" content="Cкобы для мебельного степлера каленые 6x0,7 мм 1000 шт./уп. Stelgrit, скобы +для степлера, скобы +для степлера купить, скобы +для степлера цена">
<meta name="keywords" content="Cкобы для мебельного степлера каленые 6x0,7 мм 1000 шт./уп. Stelgrit, скобы +для степлера, скобы +для степлера купить, скобы +для степлера цена">
...
a.tooltip:hover span {
  ...
  <div id="links" style="width:100%; height:30px; font-size: small;">
        ...
        <a href="Fastening_tool.aspx">Крепёжный инструмент</a> ->
        <a href="fastening_tool_3.aspx">Скобы</a>
      ...
      <strong>
         <asp:Label ID="lblName" runat="server" 
             ...
             Text="Cкобы для мебельного степлера каленые 6x0,7 мм 1000 шт./уп. &quot;Stelgrit&quot;"></asp:Label> </strong></span>
    <br />
    <br />
</div>
     <div id="photoDiv" style="width:50%;float:left;" >
         ...
         <asp:Image ID="photo" runat="server" width="350px" style="filter:FlipH;"   
             ImageUrl="images/products/655001.jpg"/>
       </div>


    <div id="parametr" style="width:50%;height:250px;float:left;">
        <strong>Артикул:</strong> 655001<br /><br />
        <strong>Мин.заказ:</strong> 50<br /><br />
        <strong>Обрабатываемая поверхность:</strong> массив дерева, двп, дсп<br /><br />
...
&nbsp;<asp:Label ID="Label1" runat="server" Text="руб."></asp:Label>
    ...
    <br/>
      ...
      <div id="content" style="width:100%;">
        <h3>Скобы для степлера, скобы для степлера купить, скобы для степлера цена</h3>
        <p>
           Скобы – тип крепежных изделий, являются оснасткой(расходным материалом)  для строительного степлера, мебельного степлера.
           Скобы  стали неизменным атрибутом современных производств.
           Часто степлер удобнее, чем молоток, но если для молотка гвозди - крепежная оснастка, то для строительного степлера - скоба.
           Мы предлагаем <strong>скобы для мебельного степлера</strong> различных размеров.
        </p>

        <p>
            <span class="auto-style1">Для справки:</span><br/>
           Степлер мебельный используется при производстве мебели, выполнении строительных и отделочных работ
           степлер строительный с помощью скоб пробивает отверстия в материалах и скрепляет их. 
           Они пробивают различные материалы и скрепляют их скобами, заклепками, гвоздями (гвоздезабиватели).
         
       </p>
       <p>
          У нас Вы можете купить скобы для степлера мебельного по оптовой цене, в зависимости от имеющихся скидок,
          акций и бонусов возможно скобы для мебельного степлера купить со скидкой до 30 процентов.
          Скобы для мебельного степлера, цена которых- наше конкурентное приемущество.
       </p>
        </div>
    ...
    <div id="also_buy" style="width:100%;margin-top:50px; height: 291px;">
        ...
        <div id="also_buy1" style="width:24%; height:200px;float:left; text-align: center;">
           <asp:ImageButton ID="ImageButton1" runat="server" 
               ImageUrl="images/products/643102.jpg" Width="160px" 
               
                
                
                
                
                PostBackUrl="Stepler_mebelny_4in1_Stelgrit.aspx?price_name=price_fastening_tool_2&amp;article=643102" />
           <br />
           <asp:HyperLink ID="hl1" runat="server" 
                
                
                NavigateUrl="Stepler_mebelny_4in1_Stelgrit.aspx?price_name=price_fastening_tool_2&amp;article=643102">Степлер мебельный 4 в 1 &quot;STELGRIT&quot;</asp:HyperLink>
        </div>
       ...
       <asp:ImageButton ID="ImageButton2" runat="server" 
               ImageUrl="images/products/643103.jpg" width="150px" 
               
               PostBackUrl="Stepler_mebelny_4_14_stelgrit.aspx?price_name=price_fastening_tool_2&amp;article=643103" 
                />
           <br />
           <asp:HyperLink ID="HyperLink2" runat="server" 
               
               
               NavigateUrl="~/Stepler_mebelny_4_14_stelgrit.aspx?price_name=price_fastening_tool_2&amp;article=643103">Степлер мебельный для скоб 4-14x0,7mm &quot;STELGRIT&quot;</asp:HyperLink>
       </div>

       <div id="also_buy3" style="width:24%; height:200px;float:left; text-align: center;">
       <asp:ImageButton ID="ImageButton3" runat="server" 
               ImageUrl="images/products/642901.jpg" Width="140px" 
               
               PostBackUrl="Stepler_mebelny_4_14_all_be_fix.aspx?price_name=price_fastening_tool_2&amp;article=642901" 
              />
           <br />
           <asp:HyperLink ID="HyperLink3" runat="server" 
               ...
               NavigateUrl="~/Stepler_mebelny_4_14_all_be_fix.aspx?price_name=price_fastening_tool_2&amp;article=642901">Степлер мебельный для скоб 4-14х0,7 мм &quot;All-Be-Fix&quot;</asp:HyperLink>
       </div>
