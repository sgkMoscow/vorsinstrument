<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Pika_po_betonu_400mm_SDS_max_RennBohr.aspx.cs" Inherits="vorsinstrument.Pika_po_betonu_400mm_SDS_max_RennBohr" %>
...
<meta name="description" content="Пика круглая по бетону 400мм SDS-max RennBohr, Купить зубило слесарное Rennbohr, пики Hagwert, зубило sds, зубила слесарные, зубило +для перфоратора, зубило sds plus, плоское зубило, зубило по бетону">
  ...
  <div id="links" style="width:100%; height:30px; font-size: small;">
      ...
      <strong>
         <asp:Label ID="lblName" runat="server" 
             ...
             Text="Пика круглая по бетону 400мм SDS-max &quot;RennBohr&quot;"></asp:Label> </strong></span>
    <br />
    <br />
</div>
    ...
    <div id="parametr" style="width:50%;height:250px;float:left;">
        <strong>Артикул:</strong> 850140<br /><br />
