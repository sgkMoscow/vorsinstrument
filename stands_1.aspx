<%@ Page Title="" Language="C#" MasterPageFile="~/Section.Master" AutoEventWireup="true" CodeBehind="stands_1.aspx.cs" Inherits="vorsinstrument.stands_1" %>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" 
    ...
    SelectCommand="SELECT [id], [article], [name], [min], ROUND([price]*(SELECT course FROM Course_EUR WHERE id = 1),2) AS [price], image  FROM [price_stands_1]">
</asp:SqlDataSource>
