<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Pika_po_betonu_600mm_SDS_max_RennBohr_by_Diager.aspx.cs" Inherits="vorsinstrument.Pika_po_betonu_600mm_SDS_max_RennBohr_by_Diager" %>
...
<meta name="description" content="Пика спиральная по бетону 600мм SDS-max Splitter Twist RennBohr by Diager, Купить зубило слесарное Rennbohr, пики Hagwert, зубило sds, зубила слесарные, зубило +для перфоратора, зубило sds plus, плоское зубило, зубило по бетону">
  ...
  <div id="links" style="width:100%; height:30px; font-size: small;">
      ...
      <strong>
         <asp:Label ID="lblName" runat="server" 
             ...
             Text="Пика спиральная по бетону 600мм SDS-max Splitter Twist &quot;RennBohr by Diager&quot;"></asp:Label> </strong></span>
    <br />
    <br />
</div>
     <div id="photoDiv" style="width:50%;float:left;" >
         ...
         <asp:Image ID="photo" runat="server" width="250px" style="filter:FlipH;"   
             ImageUrl="images/products/850125-855040.png"/>
       </div>


    <div id="parametr" style="width:50%;height:250px;float:left;">
        <strong>Артикул:</strong> 850260<br /><br />
        <strong>Мин.заказ:</strong> 1<br /><br />
