<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="buy_gun_sealant_pressor_Blast.aspx.cs" Inherits="vorsinstrument.buy_gun_sealant_pressor_Blast" %>
...
a.tooltip:hover span {
  ...
  <div id="links" style="width:100%; height:30px; font-size: small;">
      ...
      <strong><asp:Label ID="lblName" runat="server" 
             ...
             Text="Пистолет для герметика полукорпусный усиленный Pressor &quot;Blast&quot;"></asp:Label> </strong></span>
    <br />
    <br />
</div>
     <div id="photoDiv" style="width:50%;float:left;" >
         ...
         <asp:Image ID="photo" runat="server" width="250px" 
             ImageUrl="images/products/591004.jpg"/>
       </div>


    <div id="parametr" style="width:50%;height:250px;float:left;">
        <strong>Артикул:</strong> 591004<br /><br />
