<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="buy_bits_Nox_6x48.aspx.cs" Inherits="vorsinstrument.buy_bits_Nox_6x48" %>
...
a.tooltip:hover span {
    ...
    <div id="links" style="width:100%; height:30px; font-size: small;">
        <a href="Default.aspx">Главная</a> -> <a href="Bits.aspx">Биты</a> -&gt;
        <a href="bits_1.aspx">Биты для кровельных саморезов</a></div>
    
    
    
      <strong><asp:Label ID="lblName" runat="server" Text="Ключ-насадка магнитная 6х48мм 'Nox'"></asp:Label> </strong></span>
    <br />
    <br />
</div>
     <div id="photoDiv" style="width:50%;float:left;" >
         <%--<img src="images/products/556006-199.PNG" width="250px"/>--%>
         <asp:Image ID="photo" runat="server" width="250px" ImageUrl="images/products/556006-199.PNG"/>
       </div>


    <div id="parametr" style="width:50%;height:250px;float:left;">
        <strong>Размер:</strong> 6х48мм<br /><br />
...
&nbsp;<asp:Label ID="Label1" runat="server" Text="руб."></asp:Label>
    ...
    <br/>
      ...
      <div id="content" style="width:100%;">
        <br/><br/>
        Биты используются для заворачивания и отворачивания саморезов или шурупов дрелью или шуруповертом. На вид небольшой кусочек отвертки - бита, не кажется столь уж важным при проведении строительных работ, но в итоге часто бывает так, что сэкономленные копейки оборачиваются значительной потерей времени, нервов и сил. Небольшой размер этих инструментов слегка вводит в заблуждение и не дает представления о том, какой большой нагрузке они подвергаются. Поэтому биты часто рассматриваются как дешевый расходный одноразовый материал.  Хорошо ли бита и винт подходят друг к другу, вы можете проконтролировать сами: бита должна хорошо удерживаться в головке винта. Несмотря на подходящий размер, еще нет гарантии, что будет достигнута хорошая передача вращающего момента. Но при большом зазоре бита изнашивается еще быстрее.
        </div>
                    ...
                    <table cellpadding="0" cellspacing="0" class="auto-style9">
                        <tr>
                            <td class="auto-style12">
                                <asp:Image ID="PhotoZakaz" runat="server" Height="130px" ImageUrl="" />
                            </td>
