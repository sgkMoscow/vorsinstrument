<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Pika_po_betonu_250mm_SDS_plus_RennBohr.aspx.cs" Inherits="vorsinstrument.Pika_po_betonu_250mm_SDS_plus_RennBohr" %>
  ...
  <div id="links" style="width:100%; height:30px; font-size: small;">
      ...
      <strong>
         <asp:Label ID="lblName" runat="server" 
             ...
             Text="Пика круглая по бетону 250мм SDS+ &quot;RennBohr&quot;"></asp:Label> </strong></span>
    <br />
    <br />
</div>
    ...
    <div id="parametr" style="width:50%;height:250px;float:left;">
        <strong>Артикул:</strong> 850125<br /><br />
