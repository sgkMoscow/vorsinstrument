<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="buy_Error.aspx.cs" Inherits="vorsinstrument.buy_Error" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html>
<head><link rel="icon" href="http://vorsinstrument.ru/favicon.ico" type="image/x-icon">
<title>Заказ не обработан</title>
...
a.tooltip:hover span {
    ...
    <div id="links" style="width:100%; height:30px; font-size: small;">
      ...
      <strong><asp:Label ID="lblName" runat="server" Text="Сервис временно недоступен"></asp:Label> </strong></span>
      <strong>&nbsp;<br />
         <asp:Label ID="Label1" runat="server" 
             Text="Приносим свои извинения. Попробуйте оформить заказ по телефону."></asp:Label> </strong></span>
    <br />
    <br />
</div>
