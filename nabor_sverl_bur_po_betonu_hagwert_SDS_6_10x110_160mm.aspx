<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="nabor_sverl_bur_po_betonu_hagwert_SDS_6_10x110_160mm.aspx.cs" Inherits="vorsinstrument.nabor_sverl_bur_po_betonu_hagwert_SDS_6_10x110_160mm" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html>
<head><link rel="icon" href="http://vorsinstrument.ru/favicon.ico" type="image/x-icon">
<title>Cверло по бетону SDS PLUS HAGWERT купить</title>
<meta name="description" content="сверло +по бетону hagwert sds plus купить">
<meta name="keywords" content="сверло +по бетону, сверло +для перфоратора +по бетону купить сверло +по бетону, набор сверл +по бетону, сверло +по бетону цена, сверло sds +по бетону, сверла +по бетону +для дрели">
...
a.tooltip:hover span {
  ...
  <div id="links" style="width:100%; height:30px; font-size: small;">
        ...
        <a href="Drill.aspx">Буры</a> ->
        <a href="drill_1.aspx">Свёрла по бетону "Hagwert"</a>
      ...
      <strong>
         <asp:Label ID="lblName" runat="server" 
             ...
             Text="Набор буров по бетону SDS+ 5 шт: 6х110мм, 8х110мм, 6х160мм, 8х160мм, 10х160мм &quot;Hagwert&quot;"></asp:Label> </strong></span>
    <br />
    <br />
</div>
     <div id="photoDiv" style="width:50%;float:left;" >
         <%--<img src="images/products/556006-199.PNG" width="250px"/>--%>
         <asp:Image ID="photo" runat="server" width="115px" style="filter:FlipH;"   
             ImageUrl="images/products/562097-98.jpg"/>
       </div>


    <div id="parametr" style="width:50%;height:250px;float:left;">
        <strong>Артикул:</strong> 562098<br /><br />
        <strong>Мин.заказ:</strong> 1<br /><br />
        <strong>Обрабатываемая поверхность:</strong> Бетон / Кирпич<br /><br />
...
&nbsp;<asp:Label ID="Label1" runat="server" Text="руб."></asp:Label>
    ...
    <br/>
      ...
      <div id="content" style="width:100%;">
        Мы предлагаем Вам приобрести <strong>сверло по бетону</strong> для строительного оборудования. Часто используют сверло для перфоратора по бетону для сверления отверстий в сооружениях 
          и плитах, кирпичах. У нас вы можете купить сверло по бетону для выполнения необходимых работ, или как его ещё называют, 
          <strong>бур по бетону</strong>. Особой популярностью у клиентов пользуются 
          <strong>буры по бетону SDS PLUS</strong>, буры по бетону SDS MAX. Компания HAGWERT является надежным партнёром и выпускает качественную продукцию 
          мирового уровня. Вы можете приобрести сверло-бур по бетону для перфоратора SDS+ . Сверло бур по 
          бетону используют для сверления отверстий в бетоне и кирпиче. Для последующего 
          монтажа крепежных элементов дюбель гвоздей, анкеров, химических анкеров и других 
          видов крепежа. Так же отметим что буры используют для сверления отверстий под 
          кабеля, сантехнические трубы, а также для увеличения имеющихся отверстий ( путем 
          сверления множества отверстия малого диаметра вокруг уже имеющегося и 
          последующего откалывания бетона) . У нас вы можете купить сверло бур по бетону 
          для выполнения необходимых вам работ. Особой популярностью у клиентов пользуются 
          буры по бетону SDS PLUS, так как это самый распространенный тип патрона <strong>
          перфоратора</strong>. Буры Торговой марки <strong>HAGWERT</strong> хорошо 
          зарекомендовали себя в работе и имеют высокий ресурс работы . 
        </div>
    ...
    <div id="also_buy" style="width:100%;margin-top:50px; height: 291px;">
        ...
        <div id="also_buy1" style="width:24%; height:200px;float:left; text-align: center;">
           <asp:ImageButton ID="ImageButton1" runat="server" 
               ImageUrl="images/products/580511-1231.png" Width="160px" 
               
                
                
                PostBackUrl="drill_2.aspx" />
           <br />
           <asp:HyperLink ID="hl1" runat="server" 
                
                NavigateUrl="~/drill_2.aspx">Свёрла-буры  по бетону &quot;RENNBOHR&quot;</asp:HyperLink>
        </div>
       ...
       <asp:ImageButton ID="ImageButton2" runat="server" 
               ImageUrl="images/products/790411.jpg" Width="50px" 
               
               PostBackUrl="drill_3.aspx" 
                />
           <br />
           <asp:HyperLink ID="HyperLink2" runat="server" 
               
               NavigateUrl="~/drill_3.aspx">Свёрла по бетону &quot;OPTIM&quot;</asp:HyperLink>
       </div>

       <div id="also_buy3" style="width:24%; height:200px;float:left; text-align: center;">
       <asp:ImageButton ID="ImageButton3" runat="server" 
               ImageUrl="images/products/562097-98.jpg" Width="75px" 
               
               PostBackUrl="nabor_sverl_bur_po_betonu_hagwert_SDS_6_10x110_160mm.aspx?price_name=price_drill_1&amp;article=562098" 
              />
           <br />
           <asp:HyperLink ID="HyperLink3" runat="server" 
               
               
               NavigateUrl="~/nabor_sverl_bur_po_betonu_hagwert_SDS_6_10x110_160mm.aspx?price_name=price_drill_1&amp;article=562098">Набор буров по бетону SDS+ 5 шт: 6,8х110мм, 6,8,10х160мм &quot;Hagwert&quot;</asp:HyperLink>
       </div>
