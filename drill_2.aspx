<%@ Page Title="" Language="C#" MasterPageFile="~/Section.Master" AutoEventWireup="true" CodeBehind="drill_2.aspx.cs" Inherits="vorsinstrument.drill_2" %>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" 
    ...
    SelectCommand="SELECT [id], [article], [name], [min], ROUND([price]*(SELECT course FROM Course_EUR WHERE id = 1),2) AS [price], image  FROM [price_drill_2]">
</asp:SqlDataSource>
