<%@ Page Title="" Language="C#" MasterPageFile="~/Section.Master" AutoEventWireup="true" CodeBehind="fastening_tool_2.aspx.cs" Inherits="vorsinstrument.fastening_tool_2" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
    ...
    <Columns>
        ...
        <asp:ImageField DataImageUrlField="image" HeaderText="Фото" NullDisplayText="Изображение отсутствует"><ControlStyle Width="150px" /></asp:ImageField>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" 
    ...
    SelectCommand="SELECT [id], [article], [name], [min], [link], ROUND([price]*(SELECT course FROM Course_USD WHERE id = 1),2) AS [price], image  FROM [price_fastening_tool_2]">
</asp:SqlDataSource>
