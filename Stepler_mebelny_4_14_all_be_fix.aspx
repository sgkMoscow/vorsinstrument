<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Stepler_mebelny_4_14_all_be_fix.aspx.cs" Inherits="vorsinstrument.Stepler_mebelny_4_14_all_be_fix" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html>
<head><link rel="icon" href="http://vorsinstrument.ru/favicon.ico" type="image/x-icon">
<title>Степлер мебельный для скоб 4-14х0,7 мм "All-Be-Fix" : строительный инструмент</title>
<meta name="description" content="Степлер мебельный для скоб 4-14х0,7 мм All-Be-Fix, степлер мебельный, степлер строительный, степлер +для мебели,мебельный степлер купить, мебельный степлер цена">
  ...
  <div id="links" style="width:100%; height:30px; font-size: small;">
      ...
      <strong>
         <asp:Label ID="lblName" runat="server" 
             ...
             Text="Степлер мебельный для скоб 4-14х0,7 мм &quot;All-Be-Fix&quot;"></asp:Label> </strong></span>
    <br />
    <br />
</div>
     <div id="photoDiv" style="width:50%;float:left;" >
         ...
         <asp:Image ID="photo" runat="server" width="250px" style="filter:FlipH;"   
             ImageUrl="images/products/642901.jpg"/>
       </div>


    <div id="parametr" style="width:50%;height:250px;float:left;">
        <strong>Артикул:</strong> 642901<br /><br />
