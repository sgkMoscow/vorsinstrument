<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Ckoby_dlya_mebelnogo_steplera_Stelgrit_8x7.aspx.cs" Inherits="vorsinstrument.Ckoby_dlya_mebelnogo_steplera_Stelgrit_8x7" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html>
<head><link rel="icon" href="http://vorsinstrument.ru/favicon.ico" type="image/x-icon">
<title>Cкобы для мебельного степлера каленые 8x0,7 мм 1000 шт./уп. "Stelgrit"</title>
<meta name="description" content="Cкобы для мебельного степлера каленые 8x0,7 мм 1000 шт./уп. Stelgrit, скобы +для степлера, скобы +для степлера купить, скобы +для степлера цена">
  ...
  <div id="links" style="width:100%; height:30px; font-size: small;">
      ...
      <strong>
         <asp:Label ID="lblName" runat="server" 
             ...
             Text="Cкобы для мебельного степлера каленые 8x0,7 мм 1000 шт./уп. &quot;Stelgrit&quot;"></asp:Label> </strong></span>
    <br />
    <br />
</div>
    ...
    <div id="parametr" style="width:50%;height:250px;float:left;">
        <strong>Артикул:</strong> 655002<br /><br />
