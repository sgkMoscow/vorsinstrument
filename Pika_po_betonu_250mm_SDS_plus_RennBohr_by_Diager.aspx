<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Pika_po_betonu_250mm_SDS_plus_RennBohr_by_Diager.aspx.cs" Inherits="vorsinstrument.Pika_po_betonu_250mm_SDS_plus_RennBohr_by_Diager" %>
...
<meta name="description" content="Пика спиральная по бетону 250мм SDS+ Splitter Twist RennBohr by Diager, Купить зубило слесарное Rennbohr, пики Hagwert, зубило sds, зубила слесарные, зубило +для перфоратора, зубило sds plus, плоское зубило, зубило по бетону">
  ...
  <div id="links" style="width:100%; height:30px; font-size: small;">
      ...
      <strong>
         <asp:Label ID="lblName" runat="server" 
             ...
             Text="Пика спиральная по бетону 250мм SDS+ Splitter Twist &quot;RennBohr by Diager&quot;"></asp:Label> </strong></span>
    <br />
    <br />
</div>
    ...
    <div id="parametr" style="width:50%;height:250px;float:left;">
        <strong>Артикул:</strong> 850525<br /><br />
