<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Stepler_mebelny_3in1_Stelgrit.aspx.cs" Inherits="vorsinstrument.Stepler_mebelny_3in1_Stelgrit" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html>
<head><link rel="icon" href="http://vorsinstrument.ru/favicon.ico" type="image/x-icon">
<title>Степлер мебельный 3 в 1 "STELGRIT" Easy GO : строительный инструмент</title>
<meta name="description" content="Степлер мебельный 3 в 1 STELGRIT Easy GO, степлер мебельный, степлер строительный, степлер +для мебели,мебельный степлер купить, мебельный степлер цена">
<meta name="keywords" content="степлер мебельный, степлер строительный, степлер +для мебели,мебельный степлер купить, мебельный степлер цена">
...
a.tooltip:hover span {
  ...
  <div id="links" style="width:100%; height:30px; font-size: small;">
        ...
        <a href="fastening_tool_2.aspx">Степлеры</a>
      ...
      <strong>
         <asp:Label ID="lblName" runat="server" 
             ...
             Text="Степлер мебельный 3 в 1 &quot;STELGRIT&quot; Easy GO"></asp:Label> </strong></span>
    <br />
    <br />
</div>
     <div id="photoDiv" style="width:50%;float:left;" >
         ...
         <asp:Image ID="photo" runat="server" width="350px" style="filter:FlipH;"   
             ImageUrl="images/products/643101.jpg"/>
       </div>


    <div id="parametr" style="width:50%;height:250px;float:left;">
        <strong>Артикул:</strong> 643101<br /><br />
        <strong>Мин.заказ:</strong> 2<br /><br />
...
&nbsp;<asp:Label ID="Label1" runat="server" Text="руб."></asp:Label>
    ...
    <br/>
      ...
      <div id="content" style="width:100%;">
        <h3>Степлер мебельный, степлер строительный, степлер для мебели</h3>
        <p>
            <strong>Степлер мебельный</strong> используется при производстве мебели, выполнении строительных и отделочных работ
            <strong>степлер строительный</strong> с помощью скоб пробивает отверстия в материалах и скрепляет их. 
          Они пробивают различные материалы и скрепляют их скобами, заклепками, гвоздями (гвоздезабиватели).
       
          
       </p>
        <p>
           Например, при сборке мебели, ткань при помощи степлера строительного скрепляется с деревянным каркасом.
           Использование степлера для мебели позволяет существенно повысить скорость сборки мебели. 
           Мебельный степлер является незаменимым атрибутом всех современных производств.
         
       </p>
       <p>
          У нас Вы можете купить степлер для мебели по оптовой цене, в зависимости от имеющихся скидок, акций и бонусов возможно мебельный степлер купить
          со скидкой до 30 процентов. <strong>Мебельный степлер цена</strong> - наше конкурентное приемущество.
       </p>
        </div>
