<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="buy_gun_foam_fomeron_clean.aspx.cs" Inherits="vorsinstrument.buy_gun_foam_Fomeron_Clean" %>
...
a.tooltip:hover span {
    ...
    <div id="links" style="width:100%; height:30px; font-size: small;">
      ...
      <strong><asp:Label ID="lblName" runat="server" 
             Text="Пистолет для монтажной пены усиленный, тефлоновое покрытие иглы и кольца-адаптера &quot;Fomeron Clean&quot;"></asp:Label> </strong></span>
    <br />
    <br />
</div>
     <div id="photoDiv" style="width:50%;float:left;" >
         <%--<img src="images/products/556006-199.PNG" width="250px"/>--%>
         <asp:Image ID="photo" runat="server" width="250px" ImageUrl="images/products/590004.jpg"/>
       </div>


    <div id="parametr" style="width:50%;height:250px;float:left;">
        <strong>Артикул:</strong> 590004<br /><br />
   <%--     <strong>Сплав:</strong> никель<br /><br />
        ...
        <strong>Мин.заказ:</strong> 5 шт.<br /><br />
            ...
            <tr>
                <td style="width:100%;float:right">
                    <asp:Label ID="lblprice" runat="server" 
                        style="font-weight: 700; font-size: xx-large" Text="719,55"></asp:Label>
