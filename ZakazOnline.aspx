<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ZakazOnline.aspx.cs" Inherits="vorsinstrument.ZakazOnline" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html>
<head><link rel="icon" href="http://vorsinstrument.ru/favicon.ico" type="image/x-icon">
<title>Заказ онлайн строительно инструмента</title>
<meta name="description" content="Ворсинструмент: онлайн заказ строительного инструмента">
<meta name="keywords" content="Ворсинструмент: онлайн заказ строительного инструмента">
...
a.tooltip:hover span {
    ...
    <div id="links" style="width:100%; height:30px; font-size: small;">
        <a href="Default.aspx">Главная</a> -> Оформление заказа
        
        </div>
    
    
    
      <strong><asp:Label ID="lblName" runat="server" Text="Оформите Заказ прямо сейчас"></asp:Label> </strong></span>
      <strong>&nbsp;<br />
         <asp:Label ID="Label1" runat="server" 
             
             Text="Отправьте запрос через форму ниже, прикрепив фаил заказа в любом формате: doc, txt, pdf, exel, rtf и др."></asp:Label> </strong></span>
    <br />
    <br />
</div>
     <div id="photoDiv" style="width:100%;float:left;" >
         ...
         <table cellpadding="0" cellspacing="0" class="style3">
             <tr>
                 <td class="style5">
                     Ваше имя: </td>
                 <td class="style6">
                     <asp:TextBox ID="tbName" runat="server" BorderColor="#3381E6" BorderWidth="1px" 
             ...
             <tr>
                 <td class="style5">
                     Организация: </td>
                 <td class="style6">
                     <asp:TextBox ID="tbOrg" runat="server" BorderColor="#3381E6" BorderWidth="1px" 
                         Width="300px"></asp:TextBox>
                 </td>
             </tr>
             <tr>
                 <td class="style5">
                     Телефон / Email: </td>
                 <td class="style6">
                     <asp:TextBox ID="tbContact" runat="server" BorderColor="#3381E6" 
             ...
             <tr>
                 <td class="style7">
                     Сообщение: </td>
                 <td class="style8">
                     <asp:TextBox ID="tbMail" runat="server" BorderColor="#3381E6" BorderWidth="1px" 
                         Height="140px" TextMode="MultiLine" Width="300px"></asp:TextBox>
                 </td>
             </tr>
             <tr>
                 <td class="style5">
                     Выберите файл для загрузки: </td>
                 <td class="style6">
                     <asp:FileUpload ID="FileUploadZakaz" runat="server" Width="300px" />
                 </td>
             </tr>
              <tr>
                 <td class="style5">
                     &nbsp;</td>
                 <td class="style6">
                     <asp:LinkButton ID="LinkButton1" class="large blue awesome" onclick="btnSend_Click" runat="server">Отправить заказ</asp:LinkButton>
    ...
    <div id="also_buy" style="width:100%;margin-top:50px">
        ...
        <div id="also_buy1" style="width:24%; height:200px;float:left; text-align: center;">
           <asp:ImageButton ID="ImageButton1" runat="server" 
               ImageUrl="images/products/554101-554113.jpg" Width="160px" 
               PostBackUrl="bits_2.aspx" />
           <br />
           <asp:HyperLink ID="hl1" runat="server" NavigateUrl="~/bits_2.aspx">Биты INTENSA</asp:HyperLink>
        </div>
       ...
       <asp:ImageButton ID="ImageButton2" runat="server" 
               ImageUrl="/images/products/501-10-1_513-10.png" Width="130px" 
               PostBackUrl="bits_3.aspx" />
           <br />
           <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="~/bits_3.aspx">Биты GERT</asp:HyperLink>
       </div>

       <div id="also_buy3" style="width:24%; height:200px;float:left; text-align: center;">
       <asp:ImageButton ID="ImageButton3" runat="server" 
               ImageUrl="images/products/556401-416.jpg" Width="110px" 
               PostBackUrl="bits_4.aspx" />
           <br />
           <asp:HyperLink ID="HyperLink3" runat="server" NavigateUrl="~/bits_4.aspx">Биты NOX</asp:HyperLink>
       </div>

       <div id="also_buy4" style="width:24%; height:200px;float:left; text-align: center;">
       <asp:ImageButton ID="ImageButton4" runat="server" 
               ImageUrl="images/products/910-913.png" Width="160px" 
               PostBackUrl="bits_6.aspx" />
           <br />
           <asp:HyperLink ID="HyperLink4" runat="server" NavigateUrl="~/bits_6.aspx">Наборы бит</asp:HyperLink>
       </div>
