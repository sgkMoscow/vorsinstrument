<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="disk_otreznoy_almaznyj_po_keramike_hagwert_200.aspx.aspx.cs" Inherits="vorsinstrument.disk_otreznoy_almaznyj_po_keramike_hagwert_200" %>
...
<meta name="description" content="отрезной алмазный диск Hagwert купить">
<meta name="keywords" content="отрезной алмазный  диск Hagwert купить">
...
a.tooltip:hover span {
  ...
  <div id="links" style="width:100%; height:30px; font-size: small;">
        ...
        <a href="Diamond.aspx">Алмазная техника</a> ->
        <a href="diamond_disc.aspx">Диски отрезные алмазные "Hagwert"</a>
      ...
      <strong>
         <asp:Label ID="lblName" runat="server" 
             ...
             Text="Диск отрезной алмазный по керамике влажный рез 200х1,8х5х25,4/22,23 мм &quot;Hagwert&quot;"></asp:Label> </strong></span>
    <br />
    <br />
</div>
     <div id="photoDiv" style="width:50%;float:left;" >
         <%--<img src="images/products/556006-199.PNG" width="250px"/>--%>
         <asp:Image ID="photo" runat="server" width="250px" 
             ImageUrl="images/products/500000-6.jpg"/>
       </div>


    <div id="parametr" style="width:50%;height:250px;float:left;">
        <strong>Артикул:</strong> 500005<br /><br />
       <strong>Мин.заказ:</strong> 5<br /><br />
     <%--   <strong>Производитель/страна:</strong> &quot;Nox&quot; / Финляндия<br /><br />--%>
...
&nbsp;<asp:Label ID="Label1" runat="server" Text="руб."></asp:Label>
    ...
    <div id="buy" style="width:100%;margin-top:300px;">
    ...
    <div id="content" style="width:100%;">
        <br/><br/>
          <h3>Диск алмазный</h3>
          <p>
          Алмазная резка — процесс резки отверстий и проёмов различных форм в 
          строительных конструкциях (бетон, железобетон, кирпич, камень и др.) с 
          применением алмазного инструмента:<strong> алмазные диски</strong>, алмазный канат,
          алмазные коронки, цепи с алмазными сегментами. Алмазный диск применяется в строительстве
          при прокладке различных видов коммуникаций, устройстве дверных и оконных проемов, демонтаже части
          зданий или полной разборке зданий. Широко применяется алмазный диск по камню при изготовлении ниш в
          кирпичных и бетонных стенах, при резке проемов в капитальных стенах и перекрытиях. Отрезные
          <strong>алмазные диски для болгарки</strong> используют при строительстве и ремонте. Также применяется
          диск алмазный для плитки. У каждой строительной бригады внутреннего ремонта помещений, квартир есть в 
          арсенале алмазный диск по камню, <strong>диск алмазный для плитки</strong>. Этот инструмент является
          неотъемлемой и необходимой частью проведения ремонтных работ.
          </p>
          <p>
          Диск Алмазный влажный рез предназначен для работы с охлаждением водой. Для чистых пропилов в керамограните
          и плитке. 
          </p>
          <p>
          Диск Алмазный сегментный (сухой рез) предназначен для обработки бетона и материалов , качество пропилов 
          в которых не столь важно . Вертикальный прорези дополнительно охлаждают и выводят шлам из места запила.
          </p>
          <p>
          Диск Алмазный Турбо предназначен для работы в бетоне, имеет в сегменте пыли отводные канавки.
          Алмазный сегмент состоит из 28% алмазов.
          </p>
          <p>
          Диск Алмазный Супер ТУРБО, предназначен для работы в бетоне, армированном бетоне.
          Дополнительно к характеристикам Турбо имеет рельефную поверхность и отверстия в
           полотне диска для лучшего охлаждения. Алмазов в сегменте около 30%
          </p>
        </div>
    ...
    <div id="also_buy" style="width:100%;margin-top:50px; height: 291px;">
        ...
        <div id="also_buy1" style="width:24%; height:200px;float:left; text-align: center;">
           <asp:ImageButton ID="ImageButton1" runat="server" 
               ImageUrl="images\products\500000-6.jpg" Width="160px" 
               
                
                
                PostBackUrl="disk_otreznoy_almaznyj_po_keramike_hagwert_125.aspx?price_name=price_diamond_1&amp;article=500001" />
           <br />
           <asp:HyperLink ID="hl1" runat="server" 
                
                NavigateUrl="~/disk_otreznoy_almaznyj_po_keramike_hagwert_125.aspx?price_name=price_diamond_1&amp;article=500001">Диск отрезной алмазный по керамике влажный рез 125х1,8х5х22,23 мм &quot;Hagwert&quot;</asp:HyperLink>
        </div>
       ...
       <asp:ImageButton ID="ImageButton2" runat="server" 
               ImageUrl="images\products\500007-11.jpg" Width="158px" 
               
               PostBackUrl="disk_otreznoy_almaznyj_po_keramike_hagwert_230.aspx?price_name=price_diamond_1&amp;article=500006" 
                />
           <br />
           <asp:HyperLink ID="HyperLink2" runat="server" 
               
               NavigateUrl="~/disk_otreznoy_almaznyj_po_keramike_hagwert_230.aspx?price_name=price_diamond_1&amp;article=500006">Диск отрезной алмазный по керамике влажный рез 230х2х5х22,23 мм &quot;Hagwert&quot;</asp:HyperLink>
       </div>

       <div id="also_buy3" style="width:24%; height:200px;float:left; text-align: center;">
       <asp:ImageButton ID="ImageButton3" runat="server" 
               ImageUrl="images\products\500012-16.jpg" Width="169px" 
               
               PostBackUrl="disk_otreznoy_almaznyj_po_kamnyu_hagwert_super_115.aspx?price_name=price_diamond_1&amp;article=500012" 
              />
           <br />
           <asp:HyperLink ID="HyperLink3" runat="server" 
               
               NavigateUrl="~/disk_otreznoy_almaznyj_po_kamnyu_hagwert_super_115.aspx?price_name=price_diamond_1&amp;article=500012">Диск отрезной алмазный по камню Супер Турбо 115х2х7х22,23 мм &quot;Hagwert&quot;</asp:HyperLink>
       </div>

       <div id="also_buy4" style="width:24%; height:200px;float:left; text-align: center;">
       <asp:ImageButton ID="ImageButton4" runat="server" 
               ImageUrl="images\products\500017-21.jpg" Width="160px" 
               
               PostBackUrl="disk_otreznoy_almaznyj_po_kamnyu_hagwert_turbo_150.aspx?price_name=price_diamond_1&amp;article=500019" 
 />
           <br />
           <asp:HyperLink ID="HyperLink4" runat="server" 
               
               NavigateUrl="~/disk_otreznoy_almaznyj_po_kamnyu_hagwert_turbo_150.aspx?price_name=price_diamond_1&amp;article=500019">Диск отрезной алмазный по камню Турбо 150х2,2х8х22,23 мм &quot;Hagwert&quot;</asp:HyperLink>
       </div>
