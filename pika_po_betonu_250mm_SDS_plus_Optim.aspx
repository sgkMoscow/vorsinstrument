<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pika_po_betonu_250mm_SDS_plus_Optim.aspx.cs" Inherits="vorsinstrument.pika_po_betonu_250mm_SDS_plus_Optim" %>
...
<meta name="description" content="Купить зубило слесарное, пики, зубило sds, зубила слесарные, зубило +для перфоратора, зубило sds plus, плоское зубило, зубило по бетону">
<meta name="keywords" content="зубила слесарные,зубило +купить, зубило sds, зубило цена, зубила слесарные, зубило +для перфоратора, зубило sds plus, плоское зубило, зубило по бетону">
...
<%--<form action="/search" 
method="get" id="searchFrm" class="searchMain" name="search">
...
a.tooltip:hover span {
  ...
  <div id="links" style="width:100%; height:30px; font-size: small;">
        ...
        <a href="spades_1.aspx">Пики, зубила Optim</a>
      ...
      <strong>
         <asp:Label ID="lblName" runat="server" 
             ...
             Text="Пика по бетону 250мм SDS+ &quot;Optim&quot;"></asp:Label> </strong></span>
    <br />
    <br />
</div>
     <div id="photoDiv" style="width:50%;float:left;" >
         <%--<img src="images/products/556006-199.PNG" width="250px"/>--%>
         <asp:Image ID="photo" runat="server" width="130px" style="filter:FlipH;"   
             ImageUrl="images/products/791001-013_vertical.jpg"/>
       </div>


    <div id="parametr" style="width:50%;height:250px;float:left;">
        <strong>Артикул:</strong> 791005<br /><br />
