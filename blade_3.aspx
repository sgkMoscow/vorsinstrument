<%@ Page Title="" Language="C#" MasterPageFile="~/Section.Master" AutoEventWireup="true" CodeBehind="blade_3.aspx.cs" Inherits="vorsinstrument.blade_3" %>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" 
    ...
    SelectCommand="SELECT [id], [article], [name], [min], ROUND([price]*(SELECT course FROM Course_USD WHERE id = 1),2) AS [price], image  FROM [price_blade_3]">
</asp:SqlDataSource>
