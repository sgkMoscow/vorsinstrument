<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Zubilo_po_betonu_50x400mm_SDS_max_Hagwert.aspx.cs" Inherits="vorsinstrument.Zubilo_po_betonu_50x400mm_SDS_max_Hagwert" %>
...
<meta name="description" content="Зубило плоское по бетону 50х400мм SDS-max Hagwert, Купить зубило слесарное Rennbohr, пики Hagwert, зубило sds, зубила слесарные, зубило +для перфоратора, зубило sds plus, плоское зубило, зубило по бетону">
  ...
  <div id="links" style="width:100%; height:30px; font-size: small;">
      ...
      <strong>
         <asp:Label ID="lblName" runat="server" 
             ...
             Text="Зубило плоское по бетону 50х400мм SDS-max &quot;Hagwert&quot;"></asp:Label> </strong></span>
    <br />
    <br />
</div>
     <div id="photoDiv" style="width:50%;float:left;" >
         ...
         <asp:Image ID="photo" runat="server" width="350px" style="filter:FlipH;"   
             ImageUrl="images/products/509009.jpg"/>
       </div>


    <div id="parametr" style="width:50%;height:250px;float:left;">
        <strong>Артикул:</strong> 509009<br /><br />
