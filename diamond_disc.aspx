<%@ Page Title="" Language="C#" MasterPageFile="~/Section.Master" AutoEventWireup="true" CodeBehind="diamond_disc.aspx.cs" Inherits="vorsinstrument.diamond_disc" %>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" 
    ...
    SelectCommand="SELECT [id], [article], [name], [min], link, [price]*(SELECT course FROM Course_USD WHERE id = 1) AS [price], image  FROM [price_diamond_1]">
</asp:SqlDataSource>
