<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="buy_gun_foam_Blast.aspx.cs" Inherits="vorsinstrument.buy_gun_foam_Blast" %>
...
a.tooltip:hover span {
    ...
    <div id="links" style="width:100%; height:30px; font-size: small;">
      ...
      <strong>
         <asp:Label ID="lblName" runat="server" 
             Text="Пистолет для монтажной пены &quot;Blast&quot;"></asp:Label> </strong></span>
    <br />
    <br />
</div>
     <div id="photoDiv" style="width:50%;float:left;" >
         ...
         <asp:Image ID="photo" runat="server" width="250px" 
             ImageUrl="images/products/590021.jpg"/>
       </div>


    <div id="parametr" style="width:50%;height:250px;float:left;">
        <strong>Артикул:</strong> 590021<br /><br />
   <%--     <strong>Сплав:</strong> никель<br /><br />
        ...
        <strong>Мин.заказ:</strong> 4 шт.<br /><br />
            ...
            <tr>
                <td style="width:100%;float:right">
                    <asp:Label ID="lblprice" runat="server" 
                        style="font-weight: 700; font-size: xx-large" Text="375,3"></asp:Label>
