<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sverlo_po_steklu_Hagwert_10mm.aspx.cs" Inherits="vorsinstrument.Sverlo_po_steklu_Hagwert_10mm" %>
  ...
  <div id="links" style="width:100%; height:30px; font-size: small;">
      ...
      <strong>
         <asp:Label ID="lblName" runat="server" 
             ...
             Text="Сверло по стеклу 10,0мм &quot;Hagwert&quot;"></asp:Label> </strong></span>
    <br />
    <br />
</div>
    ...
    <div id="parametr" style="width:50%;height:250px;float:left;">
        <strong>Артикул:</strong> 576010<br /><br />
        <strong>Мин.заказ:</strong> 10<br /><br />
        <strong>Обрабатываемая поверхность:</strong> Стекло<br /><br />
