<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Zubilo_shtrobnik_po_betonu_22x250mm_SDS_plus_Hagwert.aspx.cs" Inherits="vorsinstrument.Zubilo_shtrobnik_po_betonu_22x250mm_SDS_plus_Hagwert" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html>
<head><link rel="icon" href="http://vorsinstrument.ru/favicon.ico" type="image/x-icon">
<title>Зубило, пики : строительный инструмент</title>
<meta name="description" content="Зубило штробник по бетону 22х250мм SDS+ Hagwert, Купить зубило слесарное Rennbohr, пики Hagwert, зубило sds, зубила слесарные, зубило +для перфоратора, зубило sds plus, плоское зубило, зубило по бетону">
<meta name="keywords" content="зубила слесарные,зубило +купить Rennbohr, Hagwert, зубило sds, зубило цена, зубила слесарные, зубило +для перфоратора, зубило sds plus, плоское зубило, зубило по бетону">
...
a.tooltip:hover span {
  ...
  <div id="links" style="width:100%; height:30px; font-size: small;">
        ...
        <a href="spades_2.aspx">Пики, зубила Rennbohr, Hagwert</a>
      ...
      <strong>
         <asp:Label ID="lblName" runat="server" 
             ...
             Text="Зубило штробник по бетону 22х250мм SDS+ &quot;Hagwert&quot;"></asp:Label> </strong></span>
    <br />
    <br />
</div>
     <div id="photoDiv" style="width:50%;float:left;" >
         <%--<img src="images/products/556006-199.PNG" width="250px"/>--%>
         <asp:Image ID="photo" runat="server" width="350px" style="filter:FlipH;"   
             ImageUrl="images/products/509006.jpg"/>
       </div>


    <div id="parametr" style="width:50%;height:250px;float:left;">
        <strong>Артикул:</strong> 509006<br /><br />
        <strong>Мин.заказ:</strong> 5<br /><br />
        <strong>Обрабатываемая поверхность:</strong> Бетон<br /><br />
...
&nbsp;<asp:Label ID="Label1" runat="server" Text="руб."></asp:Label>
    ...
    <div id="buy" style="width:100%;margin-top:400px;">
    ...
    <br/>
      ...
      <div id="content" style="width:100%;">
        <h3>Зубила слесарные, зубило по бетону, пики по бетону</h3>
        <p>
          Зубила слесарные применяются при выполнении слесарных, строительных, монтажных работ для создания канавок, обработки поверхности, пазов и отверстий.
          Зубило по бетону используется совместно с перфораторами, имеющими SDS+, SDS max патроны.
            <strong>Зубило по бетону</strong> широко применяется в столярном и слесарном деле. Зубило SDS работает со всеми производителями перфораторов.
       </p>
        <p>
         Для того, чтобы <strong>зубило купить</strong>, достаточно связаться с нашими менеджерами по телефонам на сайте, skype, либо отправив заказ на электронную почту.
         Большой ассортимент зубил sds для перфораторов, их еще называют зубило по бетону для перфоратора. Если патрон вашего перфоратора sds типа, то 
         вы можете приобрести <strong>зубило sds+</strong> (sds plus), зубило sds max, плоское зубило, пика по бетону.
       </p>
       <p>
         На сайте представлены следующие типы зубил: зубило sds+, зубило sds max, 
           <a href="Zubilo_po_betonu_20x400mm_SDS_plus_Optim.aspx?price_name=price_spades_1&amp;article=791006">зубило по бетону плоское</a>,
           <a href="Zubilo_po_betonu_22x250mm_SDS_plus_Optim.aspx?price_name=price_spades_1&amp;article=791004">зубило по бетону полое</a>,
           пика по бетону SDS+, зубило по бетону изогнутое.  
       </p>
        </div>
    ...
    <div id="also_buy" style="width:100%;margin-top:50px; height: 291px;">
        ...
        <div id="also_buy1" style="width:24%; height:200px;float:left; text-align: center;">
           <asp:ImageButton ID="ImageButton1" runat="server" 
               ImageUrl="images/products/791001-013_vertical.jpg" Width="60px" 
               
                
                
                
                PostBackUrl="Zubilo_po_betonu_20x250mm_SDS_plus_Optim.aspx?price_name=price_spades_1&article=791002" />
           <br />
           <asp:HyperLink ID="hl1" runat="server" 
                
                NavigateUrl="Zubilo_po_betonu_20x250mm_SDS_plus_Optim.aspx?price_name=price_spades_1&article=791002">Зубило по бетону плоское 20х250мм SDS+ &quot;Optim&quot;</asp:HyperLink>
        </div>
       ...
       <asp:ImageButton ID="ImageButton2" runat="server" 
               ImageUrl="/images/second_catalog/spades_2.PNG" width="150px" 
               
               PostBackUrl="spades_2.aspx" 
                />
           <br />
           <asp:HyperLink ID="HyperLink2" runat="server" 
               
               NavigateUrl="~/spades_2.aspx">Пики, зубила RENNBOHR, HAGWERT</asp:HyperLink>
       </div>
       ...
       <asp:ImageButton ID="ImageButton4" runat="server" 
               ImageUrl="images\products\850125-855040.png" Width="200px" 
               
               PostBackUrl="Zubilo_po_betonu_22x250mm_SDS_plus_RennBohr.aspx?price_name=price_spades_2&article=850325" 
              />
           <br />
           <asp:HyperLink ID="HyperLink4" runat="server" 
               
               
               NavigateUrl="~/Zubilo_po_betonu_22x250mm_SDS_plus_RennBohr.aspx?price_name=price_spades_2&article=850325">Зубило полое по бетону 22х250мм SDS+ &quot;RennBohr&quot;</asp:HyperLink>
       </div>
