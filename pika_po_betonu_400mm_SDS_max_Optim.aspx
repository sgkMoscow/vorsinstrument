<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pika_po_betonu_400mm_SDS_max_Optim.aspx.cs" Inherits="vorsinstrument.pika_po_betonu_400mm_SDS_max_Optim" %>
  ...
  <div id="links" style="width:100%; height:30px; font-size: small;">
      ...
      <strong>
         <asp:Label ID="lblName" runat="server" 
             ...
             Text="Пика по бетону 400мм SDS-max &quot;Optim&quot;"></asp:Label> </strong></span>
    <br />
    <br />
</div>
    ...
    <div id="parametr" style="width:50%;height:250px;float:left;">
        <strong>Артикул:</strong> 791012<br /><br />
