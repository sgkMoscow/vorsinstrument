<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="buyOK.aspx.cs" Inherits="vorsinstrument.buyOK" %>
...
a.tooltip:hover span {
    ...
    <div id="links" style="width:100%; height:30px; font-size: small;">
      ...
      <strong><asp:Label ID="lblName" runat="server" Text="Ваш заказ принят в обработку"></asp:Label> </strong></span>
      <strong>&nbsp;<br />
         <asp:Label ID="Label1" runat="server" 
             Text="Наши специалисты свяжутся с вами в ближайшее время, если этого не произошло, попробуйте оформить заказ по телефону"></asp:Label> </strong></span>
    <br />
    <br />
</div>
     <div id="photoDiv" style="width:50%;float:left;" >
         <%--<img src="images/products/556006-199.PNG" width="250px"/>--%>
         <asp:Image ID="photo" runat="server" width="250px" ImageUrl="~/images/Ok.png"/>
       </div>
...
&nbsp;<br/><br/>
<a class="large blue awesome" href="javascript:history.back();">Продолжить покупки &raquo;</a> <br/>&nbsp;<br/><br/>
<a class="large red awesome" href="Default.aspx">на Главную страницу &raquo;</a> <br/><br/>
