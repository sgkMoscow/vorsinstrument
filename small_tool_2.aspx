<%@ Page Title="" Language="C#" MasterPageFile="~/Section.Master" AutoEventWireup="true" CodeBehind="small_tool_2.aspx.cs" Inherits="vorsinstrument.small_tool_2" %>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" 
    ...
    SelectCommand="SELECT [id], [article], [name], [min], ROUND([price]*(SELECT course FROM Course_USD WHERE id = 1),2) AS [price], image  FROM [price_small_tool_2]">
</asp:SqlDataSource>
