<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sverlo_bur_po_betonu_hagwert_SDS_12x460mm.aspx.cs" Inherits="vorsinstrument.sverlo_bur_po_betonu_hagwert_SDS_12x460mm" %>
  ...
  <div id="links" style="width:100%; height:30px; font-size: small;">
      ...
      <strong>
         <asp:Label ID="lblName" runat="server" 
             ...
             Text="Cверло-бур по бетону SDS+ 12х460мм &quot;Hagwert&quot;"></asp:Label> </strong></span>
    <br />
    <br />
</div>
    ...
    <div id="parametr" style="width:50%;height:250px;float:left;">
        <strong>Артикул:</strong> 562032<br /><br />
