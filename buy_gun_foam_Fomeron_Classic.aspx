<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="buy_gun_foam_Fomeron_Classic.aspx.cs" Inherits="vorsinstrument.buy_gun_foam_Fomeron_Classic" %>
    ...
    <div id="links" style="width:100%; height:30px; font-size: small;">
      ...
      <strong>
         <asp:Label ID="lblName" runat="server" 
             Text="Пистолет для монтажной пены в блистере &quot;Fomeron Classic&quot;"></asp:Label> </strong></span>
    <br />
    <br />
</div>
     <div id="photoDiv" style="width:50%;float:left;" >
         ...
         <asp:Image ID="photo" runat="server" width="250px" 
             ImageUrl="images/products/590005.jpg"/>
       </div>


    <div id="parametr" style="width:50%;height:250px;float:left;">
        <strong>Артикул:</strong> 590005<br /><br />
            ...
            <tr>
                <td style="width:100%;float:right">
                    <asp:Label ID="lblprice" runat="server" 
                        style="font-weight: 700; font-size: xx-large" Text="557,1"></asp:Label>
