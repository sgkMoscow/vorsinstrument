<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="buy_gun_sealant_no_drop_Blast.aspx.cs" Inherits="vorsinstrument.buy_gun_sealant_no_drop_Blast" %>
...
<meta name="description" content="пистолет для герметика купить blast">
<meta name="keywords" content="пистолет для герметика купить blast">
...
a.tooltip:hover span {
  ...
  <div id="links" style="width:100%; height:30px; font-size: small;">
        <a href="Default.aspx">Главная</a> -> <a href="Gun.aspx">Пистолеты для пены и герметика</a> -&gt;
        <a href="gun_2.aspx">Пистолеты для герметика</a></div>
    
    
    
      <strong><asp:Label ID="lblName" runat="server" 
             
             Text="Пистолет для герметика скелетный усиленный c противокапельной системой No-drop &quot;Blast&quot;"></asp:Label> </strong></span>
    <br />
    <br />
</div>
     <div id="photoDiv" style="width:50%;float:left;" >
         ...
         <asp:Image ID="photo" runat="server" width="250px" 
             ImageUrl="images/products/591003.jpg"/>
       </div>


    <div id="parametr" style="width:50%;height:250px;float:left;">
        <strong>Артикул:</strong> 591003<br /><br />
      <%--  <strong>Сплав:</strong> никель<br /><br />--%>
...
&nbsp;<asp:Label ID="Label1" runat="server" Text="руб."></asp:Label>
    ...
    <br/>
     ...
     <div id="content" style="width:100%;">
        <br/><br/>
       <h2>Пистолет для герметика</h2>
       Во всех областях строительных работ профессионалы используют пистолет для герметика.
       Для ремонта дома рекомендуется приобретать<strong> пистолет для герметика</strong> BLAST.
       <p>Пистолет для герметика  надёжно выдавливает десятки туб с герметиком, его часто называют 
           <strong>пистолет для нанесения герметика</strong>.
       Пистолет для герметика нужен, чтобы точно дозировать герметик  и наносить её в труднодоступных местах ремонта.
       У нас одни из самых привлекательных предложений на пистолет для герметика цена - вас устроит!</p>
       <p>Вы легко можете купить пистолет для герметика  в тубах у нас в магазине, а также аксессуары к нему.
       Для того, чтобу купить пистолет под герметик, достаточно нажать кнопку КУПИТЬ на странице сайта, ввести свои контактные данные,
       и мы Вам перезвоним. Сегодня строительный пистолет для герметика очень популярен, его конструкция проста и надёжна, поэтому 
       профессиональный пистолет для герметика сегодня является основным атрибутом строительно-монтажных работ.
       </p>
       Мастера по установке окон часто сравнивают цены: мы предлагаем самый доступный 
          <strong>пистолет для герметика цена</strong> - наше конкуртентное приемущество!
       Вы знаете, что строительный пистолет для герметика, пистолет для герметика в тубах, пистолет для нанесения герметика, 
       пистолет для силиконового герметика - один и тот же пистолет, по доступной цене, в Ваших руках!
       Свяжитесь с нашими менеджерами по телефону, они помогут подобрать для Вас пистолет под герметик. 
        </div>

    <div id="also_buy" style="width:100%;margin-top:50px">
        ...
        <div id="also_buy1" style="width:24%; height:200px;float:left; text-align: center;">
           <asp:ImageButton ID="ImageButton1" runat="server" 
               ImageUrl="images/products/591001.jpg" Width="160px" 
               
                PostBackUrl="buy_gun_sealant_Caulker_Blast.aspx?price_name=price_gun_2&amp;article=591001" />
           <br />
           <asp:HyperLink ID="hl1" runat="server" 
                NavigateUrl="~/buy_gun_sealant_Caulker_Blast.aspx?price_name=price_gun_2&amp;article=591001">Пистолет для герметика скелетный Caulker &quot;Blast&quot;</asp:HyperLink>
        </div>
       ...
       <asp:ImageButton ID="ImageButton2" runat="server" 
               ImageUrl="/images/products/591003.jpg" Width="158px" 
               
               PostBackUrl="buy_gun_sealant_no_drop_Blast.aspx?price_name=price_gun_2&amp;article=591003" 
               Height="96px" />
           <br />
           <asp:HyperLink ID="HyperLink2" runat="server" 
               NavigateUrl="~/buy_gun_sealant_no_drop_Blast.aspx?price_name=price_gun_2&amp;article=591003">Пистолет для герметика скелетный усиленный c противокапельной системой No-drop &quot;Blast&quot;</asp:HyperLink>
       </div>

       <div id="also_buy3" style="width:24%; height:200px;float:left; text-align: center;">
       <asp:ImageButton ID="ImageButton3" runat="server" 
               ImageUrl="images/products/591004.jpg" Width="169px" 
               
               PostBackUrl="buy_gun_sealant_pressor_Blast.aspx?price_name=price_gun_2&amp;article=591004" 
               Height="105px" />
           <br />
           <asp:HyperLink ID="HyperLink3" runat="server" 
               NavigateUrl="~/buy_gun_sealant_pressor_Blast.aspx?price_name=price_gun_2&amp;article=591004">Пистолет для герметика полукорпусный усиленный Pressor &quot;Blast&quot;</asp:HyperLink>
       </div>

       <div id="also_buy4" style="width:24%; height:200px;float:left; text-align: center;">
       <asp:ImageButton ID="ImageButton4" runat="server" 
               ImageUrl="images/products/591006.jpg" Width="160px" 
               
               PostBackUrl="buy_gun_sealant_tube_long_Blast.aspx?price_name=price_gun_2&amp;article=591006" 
               Height="99px" />
           <br />
           <asp:HyperLink ID="HyperLink4" runat="server" 
               NavigateUrl="~/buy_gun_sealant_tube_long_Blast.aspx?price_name=price_gun_2&amp;article=591006">Пистолет для герметика алюминиевая туба Tube Long &quot;Blast&quot;</asp:HyperLink>
       </div>
