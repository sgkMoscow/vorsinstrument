<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="buy_gun_foam_Blast_Hard.aspx.cs" Inherits="vorsinstrument.buy_gun_foam_Blast_Hard" %>
...
<meta name="description" content="пистолет +для пены монтажной  fomeron">
<meta name="keywords" content="пистолет +для пены монтажной, пистолет +для монтажной пены цена, купить пистолет +для монтажной пены, пистолет под монтажную пену">
...
<input class="catSearch" id="catSearch_main" name="search" type="text" value="Поиск инструмента (более 10 000 позиций)" onblur="javascript:if(this.value==''){this.value='Поиск инструмента (более 10 000 позиций)'};" onfocus="if(this.value=='Поиск инструмента (более 10 000 позиций)') {this.value='';}" autocomplete="off" onclick="return catSearch_main_onclick()">
...
a.tooltip:hover span {
    ...
    <div id="links" style="width:100%; height:30px; font-size: small;">
        ...
        <a href="gun_1.aspx">Пистолеты для монтажной пены</a></div>
    
    
    
      <strong>
         <asp:Label ID="lblName" runat="server" 
             Text="Пистолет для монтажной пены &quot;Blast Hard&quot;"></asp:Label> </strong></span>
    <br />
    <br />
</div>
     <div id="photoDiv" style="width:50%;float:left;" >
         ...
         <asp:Image ID="photo" runat="server" width="250px" 
             ImageUrl="images/products/590022.jpg"/>
       </div>


    <div id="parametr" style="width:50%;height:250px;float:left;">
        <strong>Артикул:</strong> 590022<br /><br />
   <%--     <strong>Сплав:</strong> никель<br /><br />
        ...
        <strong>Мин.заказ:</strong> 1 шт.<br /><br />
            ...
            <tr>
                <td style="width:100%;float:right">
                    <asp:Label ID="lblprice" runat="server" 
                        style="font-weight: 700; font-size: xx-large" Text="392,4"></asp:Label>
&nbsp;<asp:Label ID="Label1" runat="server" Text="руб."></asp:Label>
    ...
    <br/>
      ...
      <div id="content" style="width:100%;">
        <br/><br/>
          Во всех областях строительных работ профессионалы используют пистолет для пены 
          монтажной. Для ремонта дома рекумендуется приобретать пистолет для пены 
          монтажной. Пистолет для монтажной пены надёжно обслуживает десятки баллонов 
          пены. Пистолет для монтажной пены нужен, чтобы точно дозировать пену и наносить 
          её в трудодоступных местах ремонта. У нас одни из самых привклекательных предложений на пистолет для пены 
          монтажной цена - вас устроит! Вы легко можете купить пистолет для монтажной пены 
          у нас в магазине, а также аксессуары к нему. Свяжитесь с нашими менеджерами по 
          телефону, они помогут подобрать для Вас пистолет под монтажную пену.</div>
    ...
    <div id="also_buy" style="width:100%;margin-top:50px">
        ...
        <div id="also_buy1" style="width:24%; height:200px;float:left; text-align: center;">
           <asp:ImageButton ID="ImageButton1" runat="server" 
               ImageUrl="images/products/590005.jpg" Width="160px" 
               PostBackUrl="bits_2.aspx" />
           <br />
           <asp:HyperLink ID="hl1" runat="server" 
                NavigateUrl="~/buy_gun_foam_Fomeron_Classic.aspx">Пистолет для монтажной пены в блистере &quot;Fomeron Classic&quot;</asp:HyperLink>
        </div>
       ...
       <asp:ImageButton ID="ImageButton2" runat="server" 
               ImageUrl="images/products/590007.jpg" Width="160px" 
               PostBackUrl="bits_3.aspx" />
           <br />
           <asp:HyperLink ID="HyperLink2" runat="server" 
               NavigateUrl="~/buy_gun_foam_Fomeron_Top.aspx">Пистолет для монтажной пены с тефлоновым покрытием &quot;Fomeron Top&quot;</asp:HyperLink>
       </div>

       <div id="also_buy3" style="width:24%; height:200px;float:left; text-align: center;">
       <asp:ImageButton ID="ImageButton3" runat="server" 
               ImageUrl="images/products/590022.jpg" Width="160px" 
               PostBackUrl="bits_4.aspx" />
           <br />
           <asp:HyperLink ID="HyperLink3" runat="server" 
               NavigateUrl="~/buy_gun_foam_Blast_Hard.aspx">Пистолет для монтажной пены &quot;Blast Hard&quot;</asp:HyperLink>
       </div>
...
<script type="text/javascript">
    ...
    function catSearch_main_onclick() {
